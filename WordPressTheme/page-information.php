...
<?php
// タブの内容を表示するためのクエリパラメータを取得
$tab = isset($_GET['tab']) ? $_GET['tab'] : 'tab01'; // デフォルトのタブを 'tab01' に設定
?>
        ...
        <div class="information__inner inner">
            <div class="information__tab information-tab">
                <ul class="information-tab__menu">
                    <li class="information-tab__menu-item js-tab-menu <?php if ($tab === 'tab01') echo 'is-active'; ?>" data-number="tab01">ライセンス<br class="u-mobile">講習</li>
                    <li class="information-tab__menu-item information-tab__menu-item--icon03 js-tab-menu <?php if ($tab === 'tab02') echo 'is-active'; ?>" data-number="tab02">体験<br class="u-mobile">ダイビング</li>
                    <li class="information-tab__menu-item information-tab__menu-item--icon02 js-tab-menu <?php if ($tab === 'tab03') echo 'is-active'; ?>" data-number="tab03">ファン<br class="u-mobile">ダイビング</li>
                </ul>
                <ul class="information-tab__content">
                    <li id="tab01" class="information-tab__content-item js-tab-content <?php if ($tab === 'tab01') echo 'is-active'; ?>">
                    ...
                    <li id="tab02" class="information-tab__content-item js-tab-content <?php if ($tab === 'tab02') echo 'is-active'; ?>">
                        <div class="information-tab__contents-wrap">
                            <div class="information-tab__contents">
                    ...
                    <li id="tab03" class="information-tab__content-item js-tab-content <?php if ($tab === 'tab03') echo 'is-active'; ?>">
                        <div class="information-tab__contents-wrap">
                            <div class="information-tab__contents">
